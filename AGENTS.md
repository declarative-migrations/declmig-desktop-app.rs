# Declarative Migrations — desktop-app.rs

Canonical `desktop-app.rs` repository for [`declarative-migrations`](https://github.com/declarative-migrations).

- Internal runtimes: Rust, TypeScript, Dart.
- Contracts: JSON Schema in `declmig-interfaces`.
